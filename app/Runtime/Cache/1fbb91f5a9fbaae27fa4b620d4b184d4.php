    ...
    <script id="contentTmpl" type="text/x-jquery-tmpl">
        <div class="c_f_after content_header">
            ...
            <div class="f_r toolbar">
                ...
                <button class="btn cmd_create_folder">新建文件夹</button>
                <button class="btn blue_btn cmd_upload">上传</button>
                {{/if}}
            </div>
        </div>
...
<div class="filename">
    ...
    <script id="newFileItemTemplate" type="text/x-jquery-tmpl">
        <div class="file_item new_file_item file_item_edit">
            ...
            <div class="edit_btns"><button class="btn blue_btn">确定</button><button class="btn">取消</button></div>
        </div>
    </script>
